...
enum L {
    ...
    enum SettingsTab {
        ...
        static var wakeup: String { localized("settings.tab.wakeup") }
    ...
    // MARK: - Settings Wakeup
    enum SettingsWakeup {
        static var section: String { localized("settings.wakeup.section") }
        static var hint: String { localized("settings.wakeup.hint") }
        static var enable: String { localized("settings.wakeup.enable") }
        static var quotaReset: String { localized("settings.wakeup.quota_reset") }
        static var dailyTimes: String { localized("settings.wakeup.daily_times") }
        static func dailyTimeSlot(_ index: Int) -> String {
            String(format: localized("settings.wakeup.daily_time_slot"), index)
        }
        static var interval: String { localized("settings.wakeup.interval") }
        static var intervalHours: String { localized("settings.wakeup.interval_hours") }
        static var currentAccount: String { localized("settings.wakeup.current_account") }
        static var noAccount: String { localized("settings.wakeup.no_account") }
        static var oauthRequired: String { localized("settings.wakeup.oauth_required") }
        static var recentStatus: String { localized("settings.wakeup.recent_status") }
        static var lastRun: String { localized("settings.wakeup.last_run") }
        static var today: String { localized("settings.wakeup.today") }
        static var failures: String { localized("settings.wakeup.failures") }
        static var history: String { localized("settings.wakeup.history") }
        static var emptyHistory: String { localized("settings.wakeup.empty_history") }
        static var clearHistory: String { localized("settings.wakeup.clear_history") }
        static var testNow: String { localized("settings.wakeup.test_now") }
        static var running: String { localized("settings.wakeup.running") }
        static var lastSuccess: String { localized("settings.wakeup.last_success") }
        static var neverRun: String { localized("settings.wakeup.never_run") }
        static var success: String { localized("settings.wakeup.success") }
        static var failed: String { localized("settings.wakeup.failed") }
        static var manual: String { localized("settings.wakeup.trigger.manual") }
        static var quotaResetTrigger: String { localized("settings.wakeup.trigger.quota_reset") }
        static var dailyTimeTrigger: String { localized("settings.wakeup.trigger.daily_time") }
        static var intervalTrigger: String { localized("settings.wakeup.trigger.interval") }
    }
    ...
    enum UsageData {
        ...
        static func nextRefresh(_ dateTime: String) -> String {
            String(format: localized("usage_data.next_refresh"), dateTime)
        }
    }
    ...
    enum UsageNotification {
        ...
        static var codexWakeupFailedTitle: String { localized("notification.codex_wakeup_failed_title") }
        static func codexWakeupFailedBody(_ message: String) -> String {
            String(format: localized("notification.codex_wakeup_failed_body"), message)
        }
        static var codexWakeupDisabledTitle: String { localized("notification.codex_wakeup_disabled_title") }
        static var codexWakeupDisabledBody: String { localized("notification.codex_wakeup_disabled_body") }
    }
