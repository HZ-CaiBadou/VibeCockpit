...
extension Logger {
    /// 应用的统一 subsystem 标识符
    private static var subsystem = Bundle.main.bundleIdentifier ?? "com.badou"
...
/*
 ...
 查看日志：
 1. Xcode Console (开发时)
 2. Console.app (搜索 subsystem:com.badou)
 3. 命令行: log show --predicate 'subsystem == "com.badou"' --last 1h
 */
