...
class DiagnosticLogger {
    ...
    /// 日志队列（用于异步写入）
    private let logQueue = DispatchQueue(label: "com.badou.logging", qos: .utility)
    ...
    /// 系统日志器
    private let osLogger = Logger(subsystem: "com.badou", category: "Diagnostics")
    ...
    private func setupLogFile() {
        ...
        let logDirectory = appSupport.appendingPathComponent("VibeCockpit/logs")
        ...
        logFileURL = logDirectory.appendingPathComponent("vibecockpit_\(dateString).log")
    ...
    private func rotateLog() {
        ...
        let archiveURL = logFileURL.deletingLastPathComponent()
            .appendingPathComponent("vibecockpit_\(timestamp).log.old")
