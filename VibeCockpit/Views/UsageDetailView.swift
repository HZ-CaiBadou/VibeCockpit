...
struct UsageDetailView: View {
    ...
    // Codex-only 版本固定展示剩余量，避免旧 UserDefaults 把浮窗带回"已使用"。
    @AppStorage("showRemainingMode") private var savedRemainingMode = UsageDisplayMath.defaultShowRemainingMode
    @State private var showRemainingMode = UsageDisplayMath.defaultShowRemainingMode
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            withTransaction(transaction) {
                showRemainingMode = UsageDisplayMath.defaultShowRemainingMode
                savedRemainingMode = UsageDisplayMath.defaultShowRemainingMode
            }
            // 如果打开时已经在刷新，启动旋转动画
