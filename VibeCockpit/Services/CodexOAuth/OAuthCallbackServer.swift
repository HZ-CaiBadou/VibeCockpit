...
final class OAuthCallbackServer {
    ...
    private let queue = DispatchQueue(label: "com.badou.oauth.callback")
    ...
    private static func responseHTML(success: Bool) -> String {
        ...
        let message = success
            ? "You can close this tab and return to VibeCockpit."
            : "Something went wrong. Please return to VibeCockpit and try again."
        return """
